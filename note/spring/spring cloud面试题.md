...
![Spring Cloud的 组件](asserts/4935fcc0a209fd1d4b70cade94986f59)
...
![Eureka 集群](asserts/25e9704082444add1192bc69c87198e9)
...
Eureka 原理，整体如下图：![Eureka 原理](asserts/80c74f1d7cb9fc2a416e7b61a055d778)
...
![image-20210422001023938](asserts/image-20210422001023938.png)
...
![Ribbon](asserts/950702ef9d35f23b5081c341c1de329a)
...
Ribbon 原理，整体如下图：![Ribbon 原理](asserts/36465fd7d91b3a4aeb3b28c3777649e6)
...
![Feign 原理](asserts/6650aa32de0def76db0e4c5228619aef)
...
![Feign + Ribbon + Eureka](asserts/252461fbb6d64d3dbc1914b7eadbfb86)
...
![Hystrix](asserts/7832f7526998500b2253f5bc0683e930)

- 作用：断路器，保护系统，控制故障范围。
- 简介：Hystrix 是一个延迟和容错库，旨在隔离远程系统，服务和第三方库的访问点，当出现故障是不可避免的故障时，停止级联故障并在复杂的分布式系统中实现弹性。

Hystrix 原理，整体如下图：![Hystrix 原理](asserts/8848af2a2e093d0421d1c7113dedefc1)
...
![HystrixCircuitBreaker 状态](asserts/01-1619021097414.png)
...
![Zuul](asserts/c1a8294fcaf03a88818e4194bb348f0b)
...
Zuul 原理，整体如下图：![Zuul 原理](asserts/20944a735d250d7d3338fe9deea179f8)
...
![Spring Cloud Config](asserts/d4610e439ae20ceb2d24020e9ff25c3a)
...
Spring Cloud Sleuth 原理，整体如下图：![Spring Cloud Sleuth 原理](asserts/43f306a2aa7bc27015d3baa7832d13b6)
...
如下是 Eureka + Ribbon + Feign + Hystrix + Zuul 整合后的图：![Eureka + Ribbon + Feign + Hystrix + Zuul](asserts/64e9a7827c76d38f899160da6f736ea2)
